      ...
      <section className="py-20 md:py-32 bg-secondary">
        <div className="container mx-auto max-w-7xl text-center">
          <h1 className="text-4xl md:text-6xl font-extrabold font-headline mb-4">
            <span className="text-primary">Unlock</span> Your Potential, <span className="text-primary">Unlocked</span>, <span className="text-primary">Live</span> a <span className="text-primary">Chilled Life</span>
          </h1>
